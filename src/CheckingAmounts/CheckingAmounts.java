...
public class CheckingAmounts {
    ...
    public static void sumOfReports(TreeMap<Integer, TreeMap<String, ArrayList<Double>>> monthlyReport, TreeMap<Integer, ArrayList<Double>> yearlyReport) {
